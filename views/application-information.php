<?php
$stage_display = [true, false, false, false];
$stage_disabled = [false, false, false, false];
$stage_background_color = ['', '', '', ''];
switch ($data['status']) {
    case '通過':
        $stage_disabled[3] = true;
        $stage_background_color[3] = 'bg-dark-subtle';
    case '會議結束':
        $stage_display[3] = true;
...
<div class="container mt-5">
  ...
  <div class="row my-4" style="display: <?= $stage_display[1] ? 'display' : 'none' ?>">
    <form action="?url=applications/application/conference-held&id=<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
      <div class="col-md-12">
            ...
            <div class="row p-1">
              ...
              <div class="col-5">
                <div class="my-2">
                  ...
                  <div class="input-group">
                    <input type="file" name="application_letter" class="form-control" required id="inputGroupFile01" <?= $stage_disabled[1] ? 'disabled' : '' ?>>
              ...
              <div class="col-5">
                <div class="my-2">
                  ...
                  <div class="input-group">
                    <input type="file" name="conference_notice" class="form-control" required id="inputGroupFile01" <?= $stage_disabled[1] ? 'disabled' : '' ?>>
  ...
  <div class="row my-4" style="display: <?= $stage_display[2] ? 'display' : 'none' ?>">
    <form action="?url=applications/application/conclude-conference&id=<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
      <div class="col-md-12">
        <div class="card <?= $stage_background_color[2] ?>">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-3" style="text-align: end">
                <button type="submit" class="btn btn-success <?= $stage_disabled[2] ? 'disabled' : '' ?>">
                  送出 <i class="bi bi-check-circle-fill"></i>
                </button>
              </div>
            </div>
          </div>
          <div class="card-body">
            <div class="row p-1">
              <div class="col-5">
                <div class="my-2">
                  <label for="formGroupExampleInput" class="form-label">會議記錄擬稿</label>
                  <div class="input-group">
                    <input type="file" name="draft_of_conference_record" class="form-control" id="inputGroupFile01" required <?= $stage_disabled[2] ? 'disabled' : '' ?>>
                    <a href="<?= $data['files']['draft_of_conference_record']['name'] ?? ""?>" class="btn btn-secondary <?= !$stage_disabled[2] ? 'disabled' : '' ?>" role="button" target="_blank">
                      下載 <i class="bi bi-file-earmark-arrow-down"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="col-5">
                <div class="my-2">
                  <label for="formGroupExampleInput" class="form-label">申請案擬稿</label>
                  <div class="input-group">
                    <input type="file" name="draft_of_application" class="form-control" id="inputGroupFile01" required <?= $stage_disabled[2] ? 'disabled' : '' ?>>
                    <a href="<?= $data['files']['draft_of_application']['name'] ?? "" ?>" class="btn btn-secondary <?= !$stage_disabled[2] ? 'disabled' : '' ?>" role="button" target="_blank">
                      下載 <i class="bi bi-file-earmark-arrow-down"></i>
                    </a>
                  </div>
                </div>
  ...
  <div class="row my-4" style="display: <?= $stage_display[3] ? 'display' : 'none' ?>">
    <form action="?url=applications/application/close&id=<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
      <div class="col-md-12">
        <div class="card <?= $stage_background_color[3] ?>">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-9 mt-2">
                <h6>第四階段</h6>
              ...
              <div class="col-3" style="text-align: end">
                <button type="submit" class="btn btn-success <?= $stage_disabled[3] ? 'disabled' : '' ?>">
                  通過 <i class="bi bi-check-circle-fill"></i>
                </button>
              </div>
            </div>
            ...
            <div class="row p-1">
              <div class="col-5">
                <div class="my-2">
                  ...
                  <div class="input-group">
                    <input type="file" name="conference_record" class="form-control" id="inputGroupFile01" required <?= $stage_disabled[3] ? 'disabled' : '' ?>>
                    <a href="<?= $data['files']['conference_record']['name'] ?? "" ?>" class="btn btn-secondary <?= !$stage_disabled[3] ? 'disabled' : '' ?>" role="button" target="_blank">
                      下載 <i class="bi bi-file-earmark-arrow-down"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="col-5">
                <div class="my-2">
                  <label for="formGroupExampleInput" class="form-label">申請案</label>
                  <div class="input-group">
                    <input type="file" name="application" class="form-control" id="inputGroupFile01" required <?= $stage_disabled[3] ? 'disabled' : '' ?>>
                    <a href="<?= $data['files']['application']['name'] ?? "" ?>" class="btn btn-secondary <?= !$stage_disabled[3] ? 'disabled' : '' ?>" role="button" target="_blank">
                      下載 <i class="bi bi-file-earmark-arrow-down"></i>
                    </a>
                  </div>
                </div>
                ...
                <div class="my-2">
                  ...
                  <div class="input-group">
                    <input type="text" name="approved_sailing_date" class="form-control" placeholder="2024-01-01"
                           value="<?= $data['approved_sailing_date'] ?>"  <?= $stage_disabled[3] ? 'disabled' : '' ?> required>
                    ...
                    <input type="text" name="approved_return_date" class="form-control" placeholder="2024-01-01"
                           value="<?= $data['approved_return_date'] ?>" <?= $stage_disabled[3] ? 'disabled' : '' ?> required>
                  </div>
                </div>
              </div>
            </div>
